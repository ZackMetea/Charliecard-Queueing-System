...
$(document).ready(function() {
	...
	document.getElementById("update").addEventListener("click", function(){
		...
		if(document.getElementById("passType").value=="TAP"){
			var daysinmonthexp= new Date(document.getElementById("expDate1").value, document.getElementById("expDate2").value,0).getDate();
		...
		var n = new Date(document.getElementById("expDate1").value, document.getElementById("expDate2").value,0).getDate();
		...
		document.getElementById("expDate1").value>12 || 
		document.getElementById("expDateday").value<1 ||  
		document.getElementById("expDateday").value>new Date(document.getElementById("expDate1").value, document.getElementById("expDate2").value,0).getDate() || 
		document.getElementById("expDate2").value<new Date().getFullYear() ||
		!isNumeric(document.getElementById("expDate1").value) ||
		!isNumeric(document.getElementById("expDateday").value) ||
		!isNumeric(document.getElementById("expDate2").value) 
